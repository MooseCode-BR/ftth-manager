/*
 * Esse modal (KMLExportModal) é um componente reutilizável projetado para exportar projetos para arquivos KML.
 */

import React, { useState, useEffect } from 'react';
import { X, CheckSquare, Square, Map, Download } from 'lucide-react';
import '../BackupModal/styles.css'; // Reutiliza os estilos do BackupModal

const KMLExportModal = ({ isOpen, onClose, projects, onConfirm }) => {
            ...
            <div className="backup-modal-content" onClick={(e) => e.stopPropagation()}>
                ...
                <div className="backup-modal-body">
                    <p className="text-sm text-gray-600 dark:text-gray-400 mb-4">
                        Selecione os projetos para exportar. Cada projeto gerará um arquivo <strong>.kml</strong> separado, compatível com Google Earth e outros. Apenas projetos pessoais podem ser exportados.
                    </p>
