/*
 * Arquivo responsável por armazenar as constantes do sistema.
 */
...
export const ABNT_COLORS = [
    { id: 1, name: 'Verde', hex: '#22c55e', text: 'text-green-600', bg: 'bg-green-500' },
    { id: 2, name: 'Amarelo', hex: '#eab308', text: 'text-yellow-600', bg: 'bg-yellow-500' },
    { id: 3, name: 'Branco', hex: '#f8fafc', text: 'text-slate-400', bg: 'bg-slate-100 border border-slate-300' },
    { id: 4, name: 'Azul', hex: '#3b82f6', text: 'text-blue-600', bg: 'bg-blue-500' },
    { id: 5, name: 'Vermelho', hex: '#ef4444', text: 'text-red-600', bg: 'bg-red-500' },
    { id: 6, name: 'Violeta', hex: '#a855f7', text: 'text-purple-600', bg: 'bg-purple-500' },
    { id: 7, name: 'Marrom', hex: '#854d0e', text: 'text-amber-800', bg: 'bg-amber-800' },
    { id: 8, name: 'Rosa', hex: '#ec4899', text: 'text-pink-600', bg: 'bg-pink-500' },
    { id: 9, name: 'Preto', hex: '#000000', text: 'text-black', bg: 'bg-black' },
    { id: 10, name: 'Cinza', hex: '#64748b', text: 'text-slate-500', bg: 'bg-slate-500' },
    { id: 11, name: 'Laranja', hex: '#f97316', text: 'text-orange-600', bg: 'bg-orange-500' },
    { id: 12, name: 'Aqua', hex: '#06b6d4', text: 'text-cyan-600', bg: 'bg-cyan-500' },
];
