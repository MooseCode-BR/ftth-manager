...
import { ABNT_COLORS, ITEM_TYPES } from '../../config/constants'; //Importação de Constantes
import { SplitterIcon } from '../../components/icons'; //Importação de Ícones
...
const DetailPanel = ({
    ...
    saveItem, pendingConn, setPendingConn, onDelete, onOpenPhotos, onAddSlotRequest, onSplitCable, onTraceRequest, onGenericEditRequest, onOTDR, onInfoRequest
}) => {
            ...
            >
                <div className="header-row">
                    ...
                    <div className="header-actions-group">
                        ...
                        {/* --- BOTÃO DE TESTE INFO MODAL --- DESABILITADO POR ENQUANTO*/}
                        {/* <button
                            onClick={() => onInfoRequest(`${item.name} - Histórico de Teste`, [
                                "Item criado no sistema",
                                "Posição atualizada para as coordenadas atuais",
                                "Conexão de fibra estabelecida com sucesso",
                                "Última edição realizada recentemente",
                            ])}
                            className="btn-action-base btn-notes-idle"
                            title="Ver Histórico (Teste)"
                        >
                            <History size={14} />
                            <span className="hidden sm:inline">Histórico | Em Breve</span>
                        </button> */}
